    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2">
          {/* CSS 3D spinning cube */}
          <div style={{ perspective: "120px" }}>
            <motion.div
              animate={{ rotateX: [0, 360], rotateY: [0, 360] }}
              transition={{ duration: 5, repeat: Infinity, ease: "linear" }}
              style={{ transformStyle: "preserve-3d", width: "36px", height: "36px", position: "relative" }}
            >
              {[
                ...
                <div key={i} style={{
                  ...
                  background: i % 2 === 0 ? "rgba(147,51,234,0.25)" : "rgba(99,32,196,0.2)",
                  border: "1px solid rgba(192,132,252,0.55)",
                  boxShadow: "inset 0 0 8px rgba(147,51,234,0.3)",
                }} />
              ))}
            </motion.div>
          </div>
          <div className="flex flex-col items-center gap-0.5">
            <span className="text-[9px] font-mono text-violet-400/55 tracking-[0.35em] uppercase">3d print</span>
            <motion.div
              className="w-px h-5 bg-gradient-to-b from-violet-500/50 to-transparent"
              animate={{ opacity: [0.3, 1, 0.3], scaleY: [0.4, 1, 0.4] }}

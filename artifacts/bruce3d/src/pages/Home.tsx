...
const services = [
  { num: "01", icon: <Printer className="w-6 h-6" />, title: "3D Печать", desc: "FDM и фотополимерная. PLA, PETG, ABS, TPU. Любая сложность.", href: "/services", tw: "from-violet-500/15 to-transparent", accent: "#a855f7" },
  { num: "02", icon: <PencilRuler className="w-6 h-6" />, title: "3D Моделирование", desc: "По фото, чертежам, размерам. Реверс-инжиниринг деталей.", href: "/services", tw: "from-blue-500/15 to-transparent", accent: "#3b82f6" },
  { num: "03", icon: <ScanLine className="w-6 h-6" />, title: "3D Сканирование", desc: "Высокоточное сканирование. Автозапчасти, техника, декор.", href: "/services", tw: "from-cyan-500/15 to-transparent", accent: "#06b6d4" },
  { num: "04", icon: <Wrench className="w-6 h-6" />, title: "Ремонт техники", desc: "3D принтеры и оборудование. Быстро и профессионально.", href: "/services", tw: "from-emerald-500/15 to-transparent", accent: "#10b981" },
];

const advantages = [
  { icon: <Zap className="w-5 h-5" />, title: "Срок от 24 часов", desc: "Быстрое производство без потери качества", color: "text-yellow-400", bg: "bg-yellow-500/10" },
  { icon: <Shield className="w-5 h-5" />, title: "Гарантия качества", desc: "Переделаем бесплатно, если что-то не так", color: "text-green-400", bg: "bg-green-500/10" },
  { icon: <Star className="w-5 h-5" />, title: "Рейтинг 5.0", desc: "Более 500 довольных клиентов", color: "text-violet-400", bg: "bg-violet-500/10" },
  { icon: <Calculator className="w-5 h-5" />, title: "Честные цены", desc: "Калькулятор онлайн, без скрытых платежей", color: "text-cyan-400", bg: "bg-cyan-500/10" },
];

const quickActions = [
  { icon: <Calculator className="w-4 h-4" />, label: "Калькулятор", href: "/calculator", cls: "border-blue-500/35 bg-blue-500/10 text-blue-300 hover:bg-blue-500/20 hover:border-blue-400/60" },
  { icon: <ShoppingBag className="w-4 h-4" />, label: "Killer Bunny™", href: "/shop", cls: "border-purple-500/35 bg-purple-500/10 text-purple-300 hover:bg-purple-500/20 hover:border-purple-400/60" },
  { icon: <Search className="w-4 h-4" />, label: "Трекер", href: "/tracker", cls: "border-cyan-500/35 bg-cyan-500/10 text-cyan-300 hover:bg-cyan-500/20 hover:border-cyan-400/60" },
  { icon: <Star className="w-4 h-4" />, label: "Отзывы", href: "/reviews", cls: "border-yellow-500/35 bg-yellow-500/10 text-yellow-300 hover:bg-yellow-500/20 hover:border-yellow-400/60" },
  { icon: <Package className="w-4 h-4" />, label: "Галерея", href: "/gallery", cls: "border-green-500/35 bg-green-500/10 text-green-300 hover:bg-green-500/20 hover:border-green-400/60" },
  { icon: <MessageSquare className="w-4 h-4" />, label: "Telegram", href: TELEGRAM_URL, cls: "border-primary/35 bg-primary/10 text-primary hover:bg-primary/20 hover:border-primary/60", external: true },
];
...
export default function Home() {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-4 pt-6 pb-12">
        ...
        <div className="relative z-10 flex flex-col items-center text-center w-full max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/40 bg-primary/10 text-primary text-xs font-semibold mb-7 backdrop-blur-sm"
          >
          ...
          >
            <div className="absolute inset-0 rounded-full bg-violet-700/30 blur-3xl" />
            ...
            <motion.div animate={{ rotate: 360 }} transition={{ duration: 16, repeat: Infinity, ease: "linear" }}
              ...
              style={{ border: "1px dashed rgba(147,51,234,0.4)" }} />
          ...
          >
            ...
            <Link href="/calculator"
              className="inline-flex h-12 items-center justify-center rounded-2xl border-2 border-primary/40 bg-primary/8 px-8 text-sm font-semibold text-white backdrop-blur-sm transition-all hover:border-primary hover:bg-primary/15 hover:scale-[1.04]">
      ...
      {/* ══════ STATS BAR ══════ */}
      <section className="relative z-10 border-y border-primary/12 bg-black/50 backdrop-blur-md">
      ...
      <section className="relative z-10 py-14 overflow-hidden">
        <div className="container mx-auto px-4 md:px-8">
          <motion.div
            ...
            className="relative rounded-3xl overflow-hidden border border-purple-500/20 bg-gradient-to-br from-purple-950/60 via-background to-violet-950/30 p-8 md:p-10"
          >
            ...
            <div className="relative flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/15 border border-primary/30 text-primary text-[10px] font-bold tracking-[0.2em] uppercase mb-3">
                ...
                <Link href="/shop"
                  className="inline-flex items-center gap-2 h-11 rounded-xl bg-primary px-6 text-sm font-bold text-white shadow-lg shadow-primary/30 transition-all hover:bg-primary/90 hover:scale-105">
      ...
      {/* ══════ SERVICES ══════ */}
      <section className="relative z-10 py-14 bg-black/25">
        <div className="container mx-auto px-4 md:px-8">
              ...
              <motion.div key={i} initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.07 }}>
                <Link href={s.href}
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <span className="text-4xl font-black opacity-12 group-hover:opacity-25 transition-opacity tabular-nums leading-none"
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              className="group flex flex-col gap-5 p-7 rounded-2xl border border-cyan-500/18 bg-gradient-to-br from-cyan-500/8 to-transparent hover:border-cyan-400/35 transition-all">
              ...
              <Link href="/tracker"
                className="inline-flex items-center gap-2 h-10 self-start rounded-xl border border-cyan-500/40 bg-cyan-500/10 px-5 text-xs font-bold text-cyan-400 transition-all hover:bg-cyan-500/20 hover:border-cyan-400 hover:scale-[1.02]">
            ...
            <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.07 }}
              className="group flex flex-col gap-5 p-7 rounded-2xl border border-primary/18 bg-gradient-to-br from-primary/8 to-transparent hover:border-primary/35 transition-all">
              <div className="flex items-center gap-4">
              ...
              <Link href="/calculator"
                className="inline-flex items-center gap-2 h-10 self-start rounded-xl bg-primary px-5 text-xs font-bold text-white shadow-lg shadow-primary/25 transition-all hover:bg-primary/90 hover:scale-[1.02]">
      ...
      <section className="relative py-28 overflow-hidden">
        <VideoBackground />
        <div className="absolute inset-0 bg-gradient-to-b from-background/70 via-black/30 to-background/70 pointer-events-none z-[1]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_80%_at_50%_50%,rgba(147,51,234,0.15),transparent)] pointer-events-none z-[1]" />
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-8 text-center">
          <motion.div initial={{ opacity: 0, scale: 0.93 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.55 }}>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/40 bg-primary/10 text-primary text-xs font-semibold mb-6">
            ...
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-black font-display uppercase mb-5 leading-tight">
              ОТ ИДЕИ ДО<br />
              <span style={{ background: "linear-gradient(90deg,#c084fc,#9333ea)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
                ГОТОВОГО РЕЗУЛЬТАТА
              </span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link href="/shop"
                className="inline-flex h-14 items-center justify-center rounded-2xl border-2 border-purple-500/40 bg-purple-500/8 px-10 text-base font-semibold text-purple-300 transition-all hover:border-purple-400 hover:bg-purple-500/15">
